...
async function getContractInstance(organisationRole) {
	...
	console.log('.....Connecting to channel - medtracchannel')
	const channel = await gateway.getNetwork('medtracchannel')

	// Get instance of deployed Certnet contract
	// @param Name of chaincode
	// @param Name of smart contract
	console.log('.....Connecting to medtracnet Smart Contract')
	return channel.getContract('medtracnet', 'org.medtrac-network.medtracnet')
}
