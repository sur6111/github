...
app.set('title', 'Medtrac App')

app.get('/', (req, res) => res.send('Hello Medtrac'))
...
app.post('/viewHistory', (req, res) => {
    console.log('Update Shipment for PO - Start')
    viewHistory
        .execute(req.body.drugName, req.body.serialNo, req.body.orgRole)
        .then((drugHistory) => {
...
app.listen(port, () =>
    console.log(`Distributed Medtrac App listening on port ${port}!`),
)
